...
| Статистика API | `/Admin/ApiStatistics` | `Settings` | Количество запросов, токены и оценка расходов по верхним тарифам AITUNNEL; разрезы по моделям и назначению, круговая диаграмма. |
