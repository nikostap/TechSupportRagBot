...
| Статистика API | `/Admin/ApiStatistics` | `Settings` | Количество запросов, токены и оценка расходов по верхним тарифам AITUNNEL; фильтр по московским календарным датам, разрезы по моделям и назначению, круговая диаграмма. |
